...
async function getJson(element, jsonObject) {
  ...
  <div class="card-content">
    ...
    <div class="card-social">
      <a href="${ele.links.facebook}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
      <a href="${ele.links.x}" target="_blank"><i class="fa-brands fa-twitter"></i></a>
      <a href="${ele.links.ensta}" target="_blank"><i class="fa-brands fa-instagram"></i></a>
      <a href="${ele.links.tiktok}" target="_blank"><i class="fa-brands fa-tiktok"></i></a>
      <a href="${ele.links.yut}" target="_blank"><i class="fa-brands fa-youtube"></i></a>
    </div>
  </div>
</div>
...
<div class="card-social">
<a href="${item.links.facebook}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
<a href="${item.links.x}" target="_blank"><i class="fa-brands fa-twitter"></i></a>
<a href="${item.links.ensta}" target="_blank"><i class="fa-brands fa-instagram"></i></a>
<a href="${item.links.tiktok}" target="_blank"><i class="fa-brands fa-tiktok"></i></a>
<a href="${item.links.yut}" target="_blank"><i class="fa-brands fa-youtube"></i></a>
</div>
</div>
</div>
